...
const Contact = () => {
  return (
    <>
      <section className="py-20 lg:py-[7.5rem] overflow-hidden relative z-10">
        <div className="container mx-auto">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[35.625rem] lg:mb-0">
                <span className="block mb-4 text-base font-semibold text-primary">
                  Contact Us
                </span>
                <h2 className="mb-6 text-[2rem] tracking-wider uppercase text-dark sm:text-[2.5rem] lg:text-[2.25rem] xl:text-[2.5rem]">
                  GET IN TOUCH
                </h2>
                <p className="text-lg leading-relaxed mb-9 text-body-color">
                  <Balancer>
                    Have any questions, comments, or just want to say hi 👋?
                    We’d love to hear from you! Fill out the form below and
                    we’ll get back to you as soon as possible.
                  </Balancer>
                </p>
                <div className="mb-8 flex w-full max-w-[23.125rem]">
                  <div className="mr-6 flex h-[3.75rem] w-full max-w-[3.75rem] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[4.375rem] sm:max-w-[4.375rem]">
                    <svg
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
                ...
                <div className="mb-8 flex w-full max-w-[23.125rem]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">
                      <a
                        href="tel:4806442291"
                        className="transition duration-150 text-primary hover:text-primary/75"
                      >
                        (480) 644-2291
                      </a>
                    </p>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                ...
                <div>
                  ...
                  <span className="absolute -right-10 top-[5.625rem] z-[-1]">
                    <svg
                      width={34}
                      height={134}
                      viewBox="0 0 34 134"
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="border-[f0f0f0] w-full resize-none rounded border py-3 px-[.875rem] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="border-[f0f0f0] w-full rounded border py-3 px-[.875rem] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
        />
      </div>
    </>
  );
